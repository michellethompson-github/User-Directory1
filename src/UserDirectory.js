...
class UserDirectory extends React.Component {
    constructor(props){ //For Initializing states
        super(props)      //States can be used to store data
    ...
    this.prevOptionHandler = this.prevOptionHandler.bind(this)
    this.nextOptionHandler = this.nextOptionHandler.bind(this)
    }
    ...
    render(){ //Only Required method
            ...
            //A render() method always have a return statement
      const data = this.state.data.map((item, index)=> `${item.name.first} ${item.name.last} lives in ${item.city}, ${item.country}` )
            ...
            <div className="main-div">
                ...
                <div className="main-section">
                    <DynamicCard userdata={this.state.data[this.state.currentState - 1]} currentuser={this.state.currentState} />
                    <div className="btns">
                        {/* Code for displaying '<' symbol */}
                    <a className="prev-btn" onClick={this.prevOptionHandler}>{'<'} Previous</a>  
                    <div class="centering">
                    <button class="center-btns">Edit</button>
                    <button class="center-btns">Delete</button>
                    <button class="center-btns">New</button>
                    </div>
                    <a className="next-btn" onClick={this.nextOptionHandler}>Next {'>'}</a>
                    </div>
                </div>
            </div>
        )
